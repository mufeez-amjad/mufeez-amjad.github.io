 ...
 render() {
    return (
        <div className="awards">
            ...
            <div className="award">
                <h3><a target='blank' href="https://www.pickering.ca/en/city-hall/civicawards.aspx">City of Pickering Civic Award</a></h3>
                <h5>June 2018</h5>
            ...
            <div className="award">
                <h3><a target='blank' href="https://www.future.utoronto.ca/content/national-book-award">UofT National Book Award</a></h3>
                <h5>Oct 2017</h5>
